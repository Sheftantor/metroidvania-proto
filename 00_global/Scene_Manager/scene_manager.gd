...
func _transition_scene ( new_scene : String, target_area : String, player_offset : Vector2, dir : String ) -> void:
...
func fade_screen( from : Vector2, to : Vector2 ) -> Signal:
	...
	tween.tween_property( fade, "position", to, 0.4 )
	return tween.finished	

func get_fade_pos( dir : String ) -> Vector2:
	var pos : Vector2 = Vector2( 480 * 3, 270 * 3 )
